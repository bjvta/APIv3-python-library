...
class TransactionalSMSApi(object):
    ...
    def send_transac_sms(self, body, **kwargs):  # noqa: E501
        """Send SMS message to a mobile number  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_transac_sms(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SendTransacSms body: Values to send a transactional SMS (required)
        :return: SendSms
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.send_transac_sms_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.send_transac_sms_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def send_transac_sms_with_http_info(self, body, **kwargs):  # noqa: E501
        """Send SMS message to a mobile number  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_transac_sms_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `send_transac_sms`")  # noqa: E501
