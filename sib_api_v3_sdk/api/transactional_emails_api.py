...
class TransactionalEmailsApi(object):
    ...
    def create_smtp_template(self, body, **kwargs):  # noqa: E501
        ...
        :param CreateSmtpTemplate body: values to update in transactional email template (required)
        :return: CreateModel
    ...
    def update_smtp_template(self, body, template_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param UpdateSmtpTemplate body: values to update in transactional email template (required)
        :param int template_id: id of the template (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
