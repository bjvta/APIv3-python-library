...
class WebhooksApi(object):
    ...
    def create_webhook(self, body, **kwargs):  # noqa: E501
        ...
        :param CreateWebhook body: Values to create a webhook (required)
        :return: CreateModel
    ...
    def update_webhook(self, body, webhook_id, **kwargs):  # noqa: E501
        """Update a webhook  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_webhook(body, webhook_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UpdateWebhook body: Values to update a webhook (required)
        :param int webhook_id: Id of the webhook (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_webhook_with_http_info(body, webhook_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_webhook_with_http_info(body, webhook_id, **kwargs)  # noqa: E501
            return data

    def update_webhook_with_http_info(self, body, webhook_id, **kwargs):  # noqa: E501
        """Update a webhook  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_webhook_with_http_info(body, webhook_id, async_req=True)
        >>> result = thread.get()
