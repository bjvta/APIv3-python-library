...
class ContactsApi(object):
    ...
    def create_doi_contact(self, body, **kwargs):  # noqa: E501
        """Create Contact via DOI (Double-Opt-In) Flow  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_doi_contact(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CreateDoiContact body: Values to create the Double opt-in (DOI) contact (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_doi_contact_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_doi_contact_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_doi_contact_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create Contact via DOI (Double-Opt-In) Flow  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_doi_contact_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_doi_contact`")  # noqa: E501
