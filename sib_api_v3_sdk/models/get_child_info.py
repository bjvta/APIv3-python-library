...
class GetChildInfo(GetClient):
    ...
    if hasattr(GetClient, "swagger_types"):
        swagger_types.update(GetClient.swagger_types)
    ...
    if hasattr(GetClient, "attribute_map"):
        attribute_map.update(GetClient.attribute_map)

    def __init__(self, credits=None, statistics=None, password=None, ips=None, api_keys=None, *args, **kwargs):  # noqa: E501
        ...
        GetClient.__init__(self, *args, **kwargs)
