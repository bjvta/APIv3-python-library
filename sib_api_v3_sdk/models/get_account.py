...
class GetAccount(GetExtendedClient):
    ...
    if hasattr(GetExtendedClient, "swagger_types"):
        swagger_types.update(GetExtendedClient.swagger_types)
    ...
    if hasattr(GetExtendedClient, "attribute_map"):
        attribute_map.update(GetExtendedClient.attribute_map)

    def __init__(self, plan=None, relay=None, marketing_automation=None, *args, **kwargs):  # noqa: E501
        ...
        GetExtendedClient.__init__(self, *args, **kwargs)
