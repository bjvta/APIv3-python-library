...
import six
from sib_api_v3_sdk.models.get_campaign_overview import GetCampaignOverview  # noqa: F401,E501

class GetExtendedCampaignOverview(GetCampaignOverview):
    ...
    if hasattr(GetCampaignOverview, "swagger_types"):
        swagger_types.update(GetCampaignOverview.swagger_types)
    ...
    if hasattr(GetCampaignOverview, "attribute_map"):
        attribute_map.update(GetCampaignOverview.attribute_map)

    def __init__(self, test_sent=None, header=None, footer=None, sender=None, reply_to=None, to_field=None, html_content=None, share_link=None, tag=None, created_at=None, modified_at=None, inline_image_activation=None, mirror_active=None, recurring=None, sent_date=None, return_bounce=None, *args, **kwargs):  # noqa: E501
        ...
        GetCampaignOverview.__init__(self, *args, **kwargs)
